function clickRedirect(element) {
    if (element.id == "redic_cmds") {
        ...
        window.open('https://discord.com/oauth2/authorize?client_id=821452429409124451&scope=bot%20applications.commands&permissions=1238334041302&redirect_uri=https%3A%2F%2Fwebmaplebotml.up.railway.app%2Fapi%2Fthanks&response_type=code')
